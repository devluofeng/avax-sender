...
const address = DISPERSEABI.avaxMainnet; // change
...
const Tokens = () => {
    ...
    if ((chainId === 43113 || chainId === 56) && active) {
        return(
            <Grid>
                <Grid.Row>
                    <Grid.Column width={3}>
        ...
        return(
            <Grid>
                <Grid.Row>
                    ...
                    <Grid.Column width={10}>
                        <Grid.Row>
                            {!(chainId === 43113 || chainId === 56) ?
                            <div><p>This DAPP only supports Avax Testnet(Chain ID : 43113) and Avax Mainnet ( Chain ID : 56)</p></div>
                            : <div></div>}
                        </Grid.Row>
                        <Grid.Row>
